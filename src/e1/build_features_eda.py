"""Construcción de features para E1 (Estrategia Conservadora) - version EDA.

Este modulo existe para evidencia historica en notebooks EDA. Reintroduce
features descartadas luego por multicolinealidad para mostrar el primer
...
def compute_e1_features(df: pd.DataFrame) -> pd.DataFrame:
    """Calcula features para E1 (version EDA legacy).
    ...
    # close_sma200_dist: Reintroducida en esta version EDA para documentar
    # su correlacion en el primer analisis.
