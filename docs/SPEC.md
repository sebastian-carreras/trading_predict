# Especificación técnica — Proyecto Final

> **Material académico.** Este documento es la especificación de diseño del proyecto final de la
> Especialización en Inteligencia Artificial (FIUBA, Universidad de Buenos Aires): arquitecturas
> por estrategia, hiperparámetros, lógica de señales, checklist de implementación y
> especificación de datos.
>
> Se mantiene **en español** de forma deliberada, porque su audiencia es la dirección de tesis y
> los evaluadores del CEIA. La documentación orientada a portfolio está en inglés, empezando por
> el [README](../README.md).
>
> ⚠️ **Documento histórico.** Refleja el diseño tal como fue especificado. Donde la
> implementación real terminó divergiendo, hay una nota al pie marcándolo. Para lo que el sistema
> hace **hoy**, la fuente es el [README](../README.md) y el código.
...
> ⚠️ **Superado por la implementación.** El split 70/15/15 quedó descartado: E1 y E2 usan
> **walk-forward con embargo ≥ horizonte** en las 5 folds, que es lo que efectivamente corre en
> el pipeline y lo que reportan las métricas del README. Ver
> [README_WALK_FORWARD.md](../README_WALK_FORWARD.md).
...
[1] Carreras, S. — *Proyecto Final v4.2*, Especialización en IA, FIUBA (documento de tesis, no publicado en línea).
