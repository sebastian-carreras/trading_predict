...
Median across champions vs. the fixed baseline (Linear Regression for E1):
...
- **Orchestration:** Airflow DAGs per strategy; full stack via `docker-compose --profile all`
...
Per-strategy details live in [README_E1.md](README_E1.md), [README_E2.md](README_E2.md),
[README_E3.md](README_E3.md), [README_E4.md](README_E4.md); the full project overview is in
[README.md](README.md).
